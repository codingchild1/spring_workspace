   ...
   <div class="container mt-3">
        ...
        <form id='form' action="makeaccount" method="post">
            <div class="input-group mb-2">
                ...
                <button type="button" class="btn btn-info" id="accidoverlap">중복</button>
            </div>
            <div class="input-group mb-2">
            ...
            <div class="d-grid">
                <input type="submit" id="submit" class="btn btn-primary btn-block" value='계좌개설'>
            </div>
        </form>
    </div>
    ...
    <script>
	    $('#accidoverlap').click(function () {
			...
			$.ajax({
				...
				dataType:"text",
				async:false,
				url:"http://localhost:8080/accountoverlap",
				data:{id:$('#id').val()},
