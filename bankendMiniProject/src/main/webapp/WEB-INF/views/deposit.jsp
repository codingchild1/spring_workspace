            ...
            <form id='form'>
                <div class="flex">
                    <ul class="container">
                        ...
                        <li class="item">
                            <input type="text"  placeholder="계좌번호를 입력하세요." autofocus id="id" name="id">
                        </li>
                        <li class="item">
                    ...
                    <ul class="container">
                        ...
                        <li class="item">
                            <input type="text" placeholder="입금액을 입력하세요." id="money" name="money">
                        </li>
                    </ul>
                </div>
                <button class="submit">입금</button>
            </form>
        </div>
        <div class="caution">
            <h6><b>서비스 이용시간</b></h6>
            ...
            <form id='form2'>
                <div class="flex">
                    ...
                    <ul class="container">
                        ...
                        <li class="item">
                            <input type="text" style="color: #3182f6; text-align: end; font-weight: bold;" id="deposit"
